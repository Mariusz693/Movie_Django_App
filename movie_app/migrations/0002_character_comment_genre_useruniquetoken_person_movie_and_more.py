# Generated by Django 4.0.3 on 2022-09-29 18:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characters', models.ManyToManyField(blank=True, related_name='characters', through='movie_app.Character', to='movie_app.person', verbose_name='Aktorzy')),
